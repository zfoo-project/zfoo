 ...
 * @author godotg
 */
public class DartObjectProtocolSerializer implements IDartSerializer {
    ...
    public String readObject(StringBuilder builder, int deep, Field field, IFieldRegistration fieldRegistration) {
        ...
        GenerateProtocolFile.addTab(builder, deep);
        builder.append(StringUtils.format("var {} = buffer.readPacket({}) as {};", result, objectProtocolField.getProtocolId(), protocolSimpleName))
                .append(LS);
        return result;
    }
