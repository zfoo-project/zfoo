 ...
 * @author godotg
 */
public class JavaSetSerializer implements IJavaSerializer {

    @Override
    public void writeObject(StringBuilder builder, String objectStr, int deep, Field field, IFieldRegistration fieldRegistration) {
        GenerateProtocolFile.addTab(builder, deep);
        if (CutDownSetSerializer.getInstance().writeObject(builder, objectStr, field, fieldRegistration, CodeLanguage.Java)) {
            return;
        }
        ...
        CodeGenerateJava.javaSerializer(setField.getSetElementRegistration().serializer())
    ...
    public String readObject(StringBuilder builder, int deep, Field field, IFieldRegistration fieldRegistration) {
        GenerateProtocolFile.addTab(builder, deep);
        var cutDown = CutDownSetSerializer.getInstance().readObject(builder, field, fieldRegistration, CodeLanguage.Java);
        if (cutDown != null) {
            return cutDown;
        }
        ...
        var typeName = CodeGenerateJava.toJavaClassName(setField.getType().toString());
...
//        builder.append("var " + result + " = new " + typeName + "(" + size + ");" + LS);
        ...
        var readObject = CodeGenerateJava.javaSerializer(setField.getSetElementRegistration().serializer())
