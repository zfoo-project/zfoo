 ...
 * @author godotg
 */
public class DartSetSerializer implements IDartSerializer {
    ...
    public void writeObject(StringBuilder builder, String objectStr, int deep, Field field, IFieldRegistration fieldRegistration) {
        ...
        if (CutDownSetSerializer.getInstance().writeObject(builder, objectStr, field, fieldRegistration, CodeLanguage.Dart)) {
            return;
        }
        ...
        CodeGenerateDart.dartSerializer(setField.getSetElementRegistration().serializer())
    ...
    public String readObject(StringBuilder builder, int deep, Field field, IFieldRegistration fieldRegistration) {
        GenerateProtocolFile.addTab(builder, deep);
        var cutDown = CutDownSetSerializer.getInstance().readObject(builder, field, fieldRegistration, CodeLanguage.Dart);
        if (cutDown != null) {
            return cutDown;
        }
        ...
        var typeName = CodeGenerateDart.toDartClassName(setField.getType().toString());
        ...
        GenerateProtocolFile.addTab(builder, deep);
        builder.append(StringUtils.format("{} {} = Set();", typeName, result)).append(LS);
        ...
        var readObject = CodeGenerateDart.dartSerializer(setField.getSetElementRegistration().serializer())
