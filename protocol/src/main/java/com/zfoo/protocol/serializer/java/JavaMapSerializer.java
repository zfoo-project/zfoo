 ...
 * @author godotg
 */
public class JavaMapSerializer implements IJavaSerializer {

    @Override
    public void writeObject(StringBuilder builder, String objectStr, int deep, Field field, IFieldRegistration fieldRegistration) {
        GenerateProtocolFile.addTab(builder, deep);
        if (CutDownMapSerializer.getInstance().writeObject(builder, objectStr, field, fieldRegistration, CodeLanguage.Java)) {
            return;
        }
        ...
        CodeGenerateJava.javaSerializer(mapField.getMapKeyRegistration().serializer())
                .writeObject(builder, key, deep + 2, field, mapField.getMapKeyRegistration());
        CodeGenerateJava.javaSerializer(mapField.getMapValueRegistration().serializer())
    ...
    public String readObject(StringBuilder builder, int deep, Field field, IFieldRegistration fieldRegistration) {
        GenerateProtocolFile.addTab(builder, deep);
        var cutDown = CutDownMapSerializer.getInstance().readObject(builder, field, fieldRegistration, CodeLanguage.Java);
        if (cutDown != null) {
            return cutDown;
        }
        ...
        var typeName = CodeGenerateJava.toJavaClassName(mapField.getType().toString());
        ...
        String keyObject = CodeGenerateJava.javaSerializer(mapField.getMapKeyRegistration().serializer())
                .readObject(builder, deep + 2, field, mapField.getMapKeyRegistration());


        String valueObject = CodeGenerateJava.javaSerializer(mapField.getMapValueRegistration().serializer())
