...
public class KtArraySerializer implements IKtSerializer {
    ...
    public String readObject(StringBuilder builder, int deep, Field field, IFieldRegistration fieldRegistration) {
        ...
        GenerateProtocolFile.addTab(builder, deep);
        var pair = CodeGenerateKotlin.ktSerializer(arrayField.getArrayElementRegistration().serializer()).fieldTypeDefaultValue(field, arrayField.getArrayElementRegistration());
